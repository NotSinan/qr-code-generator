...
def main():
    ...
    parser.add_argument('-o', '--output', type=str, help='Output file for generated QR code (default: qrcode.svg)',
                        default='qrcode.svg')
    ...
    parser.add_argument('-q', '--quiet-zone', type=int, help='Size of the quiet zone around the QR code (default: 4)',
                        default=4)
    parser.add_argument('-c', '--bg-color', type=str, help='Background color of the QR code', default='#ffffff')
    parser.add_argument('-m', '--module-color', type=str, help='Module color of the QR code', default='#111111')
